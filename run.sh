...
if [[ $ROLE = 'api' ]]; then
  ...
  REDIS_HOST=${FAST_PRIORITY_QUEUE_TARGET_REDIS_HOST:-localhost}
  REDIS_USER="${FAST_PRIORITY_QUEUE_TARGET_REDIS_USER:-}"
  REDIS_PASSWORD="${FAST_PRIORITY_QUEUE_TARGET_REDIS_PASSWORD:-}"
  REDIS_PORT="${FAST_PRIORITY_QUEUE_TARGET_REDIS_PORT:-}"
  AUTH=""
